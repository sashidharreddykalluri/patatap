# patatap - This is a simple application that generates circles with different colors whenver a user clicks on the black screen. Along with the circles it'll produce various sounds as well.
